...
p <- ggplot(df, aes(x = Group, y = value, fill = Group)) +
  ...
  labs(
    x = "Group",
    y = "Insertion Length (bp)",
    title = "Insertion Length (Insertions ≥ 3000 bp)"
  ) +
...
write_csv(export_table, "Insertions_3000bp.csv")

# -------------------------------
# Save plot
# -------------------------------
ggsave(
  filename = "Insertions_3000bp.tiff",
  plot = p,
